...
namespace TextureChannelMixer
{
    ...
    public class ModifierHiddenAttribute : Attribute
    {
    ...
    public enum EColorChannel { None, Red, Green, Blue, Alpha }
    ...
    public class ChannelMixerViewer : EditorWindow
    {
        private static List<Texture2D> referenceTextures = new List<Texture2D>();
        private static List<List<Texture2D>> referenceBulkTextures = new List<List<Texture2D>>();
        private static List<string> referenceTextureNames = new List<string>();
        private static float imageSize = 128;
        private static Vector2 scrollPosition;
        private static bool autoUpdate = true;
        private static bool autoSize = true;
        private static int resultWidth = 512;
        private static int resultHeight = 512;

        private Event e;

        public Texture2D addImageImage;
        public Texture2D nodeConnectionImage;
        public Texture2D nodeConnectionSelectedImage;
        public Texture2D arrowUpImage;
        public Texture2D arrowDownImage;
        public Texture2D mouseLeftImage;
        public Texture2D mouseRightImage;
        public Texture2D saveIconImage;
        public Texture2D loadIconImage;
        public Texture2D clearIconImage;
        public Texture2D transparencyImage;
        ...
        {
            ChannelMixerViewer window = GetWindow<ChannelMixerViewer>("Texture Channel Mixer");
            window.Show();
        }
        ...
        void OnEnable()
        {
            ...
            mixChannelMaterial = new Material(Shader.Find("Hidden/MixChannels"));
            ...
            reorderButtonStyle = new GUIStyle { padding = new RectOffset(2, 2, 2, 2) };
        ...
        void UpdatePresetButtons()
        {
            ...
            path = Path.Combine(path ?? throw new InvalidOperationException("Error path"), "Presets");
