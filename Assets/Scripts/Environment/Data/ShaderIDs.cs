...
namespace Environment.Data
{
    public class ShaderIDs
    {
        ...
        internal static readonly int Pi316 = Shader.PropertyToID("_Pi316");
        internal static readonly int Pi14 = Shader.PropertyToID("_Pi14");
        internal static readonly int Pi = Shader.PropertyToID("_Pi");
